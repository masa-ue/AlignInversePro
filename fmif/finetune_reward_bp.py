...
import wandb
import sys
sys.path.append('/home/wangc239/mdlm/seqft/multiflow')
# print(sys.path)
...
# TODO
# 1. add val and test set
# 2. add rmsd calculation
# 3. for each val/test protein, generate 100 samples and calculate the rmsd distribution for each
# 4. check Nisnoff et al. whether the test protein is included in oracle training
# 5. check stability distribution of the generated proteins in proteindpo training set and Nisnoff et al. test set (3)
...
def main(args, log_path, save_path):
    ...
    old_fmif_model.load_state_dict(torch.load('/data/wangc239/pmpnn/outputs/jnvGDJFmCj_20240710_145313/model_weights/epoch300_step447702.pt')['model_state_dict'])
    ...
    reward_model_eval.load_state_dict(torch.load('/data/wangc239/protein_oracle/outputs/tVDvJCwyIe_20240827_124027/model_weights/epoch100_step372900.pt')['model_state_dict'])
